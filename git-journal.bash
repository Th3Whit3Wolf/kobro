_git-journal() {
    ...
    case "${cmd}" in
        git-journal)
            opts=" -a -g -s -u -h -V -p -n -e -t -o -i  --all --generate --short --skip-unreleased --help --version --path --tags-count --template --output --ignore  <revision range>  prepare setup verify help  p  s  v"
